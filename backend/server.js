...
const [basic, pro, business] = [
  "price_1P6QvtSAxSrvOkB3Lmc7y3oQ",
  "price_1P6QxPSAxSrvOkB3j5yqQOnD",
  "price_1P6QyISAxSrvOkB3leuNFzg7",
];

admin.initializeApp({
  credential: admin.credential.cert(serviceAccount),
  databaseURL:
    "https://stripe-subscription-app-7935b-default-rtdb.firebaseio.com",
});
